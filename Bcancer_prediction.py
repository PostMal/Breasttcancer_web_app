...
bcancer_model = pickle.load(open('C:/Users/pc/Desktop/breast cancer prediction system/Saved Model/BreastCancer_Model (4).sav','rb'))
...
if(selected == 'Cancer prediction'):
    ...
    if(cancer_prediction[0] == 1 ):
            cancer_diagnosis = 'You got a Benign Breast Cancer'
    else:
            cancer_diagnosis = 'You got a Malignant Breast Cancer'
